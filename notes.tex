...
\caption{Density of states of the impact of the outermost layer of ice on chloride ion with PBE functional.}
\label{figure6}
\end{figure}
...
\caption{Density of states of the impact of the outermost layer of ice on chloride ion with SAOP model.}
\label{figure1a}
\end{figure}
