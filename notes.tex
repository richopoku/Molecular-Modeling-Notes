...
\begin{figure}[H]\large
\includegraphics[width = 14.0cm, trim = 0cm 0cm 10cm 0cm]{newfig50-100bar_edit.png}
...
\begin{figure}[H]\large
\includegraphics[width = 15.0cm, trim = 0cm 0cm 10cm 0cm]{nospincombTZ2P_r_r.png}
...
\begin{figure}[H]\large
\includegraphics[width = 15.0cm, trim = 0cm 0cm 10cm 0cm]{nospincombQZ4P_r_r.png}
...
\begin{figure}[H]\large
\includegraphics[width = 15.0cm, trim = 0cm 0cm 10cm 0cm]{spincombTZ2P_r_r.png}
...
\begin{figure}[H]\large
\includegraphics[width = 15.0cm, trim = 0cm 0cm 10cm 0cm]{spincombQZ4P_r_r.png}
...
\begin{figure}[H]\large
\includegraphics[width = 15.0cm, trim = 0cm 0cm 10cm 0cm]{nospincombTZ2P_r_w.png}
...
%\begin{figure}[H]\large
%\includegraphics[width = 12.0cm, trim = 0cm 0cm 10cm 0cm]{spincombTZ2P_r_w.png}
%\caption{Electron binding energies spectra of $[Cl^{-1}/(H_{2}O)_{n}]$ and $[(Cl(H_{2}O)_{10})^{-1}/%(H_{2}O)_{n}]$ for various cluster size using the DC-ZORA, SAOP model and TZ2P basis set; where n is %the number of water molecules in the subsystem of the environment}
%\label{figure52}
%\end{figure}

%\begin{figure}[H]\large
%\includegraphics[width = 15.0cm, trim = 0cm 0cm 10cm 0cm]{spincombQZ4P_r_w.png}
%\caption{Electron binding energies spectra of $[Cl^{-1}/(H_{2}O)_{n}]$ and $[(Cl(H_{2}O)_{10})^{-1}/(H_{2}O)_{n}]$ for various cluster size using the DC-ZORA, SAOP model and QZ4P basis set; where n is the number of water molecules in the subsystem of the environment}
%\label{figure53}
%\end{figure}
