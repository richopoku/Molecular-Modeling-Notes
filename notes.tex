...
\begin{figure}[H]\large
\includegraphics[width = 17.0cm, trim = 0cm 0cm 10cm 0cm]{newfig50-100bar_edit.png}
\caption{Effect of ice surface on chloride ion for 50 and 100 water molecules.}
\label{figure45}
\end{figure}

\begin{figure}[H]\large
\includegraphics[width = 5.0cm, trim = 0cm 0cm 10cm 0cm]{imagefnt50-40-0-10d_edit2.png}
\caption{}
\label{figure46}
\end{figure}

\begin{figure}[H]\large
\includegraphics[width = 9.0cm, trim = 0cm 0cm 10cm 0cm]{imagefnt100-90-0-10d_edit2.png}
