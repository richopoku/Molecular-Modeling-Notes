...
\includegraphics[width = 15.0cm, trim = 0cm 0cm 10cm 0cm]{potcomb.png}
...
\begin{table}[H]\small
\begin{center}
\caption{Comparison of the highest occupied molecular orbital (HOMO) energies for SAOP and PBE as a function of variation of in the number of water molecules of Chloride ion adsorption on ice surface} \label{tab:1}
...
\hline
$Cl^{-}$&\hspace*{1.0cm}-0.120&\hspace*{1.0cm}0.325&\hspace*{1.0cm}0.029&\hspace*{1.0cm}0.473\\
\hline
$Cl^{-}$/1 $H_{2}O$&\hspace*{1.0cm}-0.119&\hspace*{1.0cm}-0.087&\hspace*{1.0cm}0.283&\hspace*{1.0cm}-0.679\\
\hline
$Cl^{-}$/10 $H_{2}O$&\hspace*{1.0cm}-0.126&\hspace*{1.0cm}-0.096&\hspace*{1.0cm}0.021&\hspace*{1.0cm}-0.002\\
\hline
$Cl^{-}$/50 $H_{2}O$&\hspace*{1.0cm}-0.116&\hspace*{1.0cm}-0.134&\hspace*{1.0cm}0.145&\hspace*{1.0cm}-0.669\\
\hline
$Cl^{-}$/100 $H_{2}O$&&&\hspace*{1.0cm}0.006&\hspace*{1.0cm}-0.047\\
\hline
$Cl^{-}$/150 $H_{2}O$&&&\hspace*{1.0cm}0.158&\hspace*{1.0cm}-0.659\\
\hline
$Cl^{-}$/200 $H_{2}O$&&&\hspace*{1.0cm}0.116&\hspace*{1.0cm}-0.894\\
\hline
\end{tabular}
\label{table1}
\end{center}
...
\begin{figure}[H]\large
\includegraphics[width = 15.0cm, trim = 0cm 0cm 10cm 0cm]{pbegraph.png}
...
&\hspace*{1.0cm}(SAOP)&\hspace*{1.0cm}(SAOP)&\hspace*{1.0cm}(PBE)&\hspace*{1.0cm}(PBE)\\ 
\hline
HCl&\hspace*{1.0cm}-0.458&\hspace*{1.0cm}-0.190&\hspace*{1.0cm}-0.295&\hspace*{1.0cm}-0.365\\
\hline
HCl/1 $H_{2}O$&\hspace*{1.0cm}-0.456&\hspace*{1.0cm}-0.190&\hspace*{1.0cm}-0.267&\hspace*{1.0cm}-0.036\\
\hline
HCl/10 $H_{2}O$&\hspace*{1.0cm}-0.450&\hspace*{1.0cm}-0.195&\hspace*{1.0cm}-0.261&\hspace*{1.0cm}-0.043\\
\hline
HCl/50 $H_{2}O$&\hspace*{1.0cm}-0.399&\hspace*{1.0cm}-0.222&\hspace*{1.0cm}-0.214&\hspace*{1.0cm}-0.086\\
\hline
HCl/100 $H_{2}O$&\hspace*{1.0cm}-0.372&\hspace*{1.0cm}-0.211&\hspace*{1.0cm}&\hspace*{1.0cm}\\
\hline
HCl/150 $H_{2}O$&\hspace*{1.0cm}&\hspace*{1.0cm}&\hspace*{1.0cm}&\hspace*{1.0cm}\\
\hline
HCl/200 $H_{2}O$&\hspace*{1.0cm}&\hspace*{1.0cm}&\hspace*{1.0cm}&\hspace*{1.0cm}\\
\hline
\end{tabular}
\label{table1}
\end{center}
